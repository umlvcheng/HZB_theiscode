...
%  subplot(1,3,2)
%  figure
pcolor(distsec(1:10,:)/1,zsec(2:11,:),cross_vel);
 shading interp
  hold on; 
%  figure
% [clab,hlab]=contour(distsec(1:10,:)/1,zsec(2:11,:),cross_vel,10,'Linecolor','k');
[clab,hlab]=contour(distsec(1:10,:)/1,zsec(2:11,:),cross_vel,'Linecolor','k');
% clabel(clab)
set(hlab,'LineWidth',0.1)
clabel(clab,hlab,'Fontsize',12,'Fontname','Cambia','Color','k','Rotation',45,'LabelSpacing',450);
hold off
 
 shading flat
 xlabel('Distance [ m]','Margin',2,'Fontsize',22,'Fontname','Cambia','FontWeight','Bold')
 ylabel('Depth [ m]','Margin',2,'Fontsize',22,'Fontname','Cambia','FontWeight','Bold')
 set(gca,'FontSize',22,'FontName','Cambria')
 colorbar
 caxis([-2.5 2.5]);
%  colorbar;
 %title('Current Transect AA`,Ebbing, 2005', 'Margin',2,'Fontsize',14,'Fontname','Cambia');
 %title('Current Transect BB`,Flooding, 2005', 'Margin',2,'Fontsize',14,'Fontname','Cambia');
 %title('Current Transect BB`,Ebbing, 2005', 'Margin',2,'Fontsize',14,'Fontname','Cambia');
 %title('Current Transect DD`,Ebbing, 2005', 'Margin',2,'Fontsize',14,'Fontname','Cambia');
%  title('Current Transect DD`,Flooding, 2005', 'Margin',2,'Fontsize',14,'Fontname','Cambia');
 title(colorbar,'(m/s)')
